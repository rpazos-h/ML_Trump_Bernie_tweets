...
# Author : Rodrigo Pazos
# Homework 1: Predicting Bernie's and Trump's Tweets
...
tidy_w2v_test <- readRDS("test_w2v.rds")
tidy_w2v_train <- readRDS("train_w2v.rds")
tidy_tweets_topwords_test <- readRDS("test_top500_words.rds")
tidy_tweets_topwords_train <- readRDS("train_top500_words.rds")

freq_words <- readRDS("freq_words.rds")


# Packages

list.of.packages <- c("tidyverse", "nnls", 'kableExtra', "quadprog", "SuperLearner", "ggplot2", "raster", "sp", "rgdal", 
                      "rgeos", "glmnet", "Matrix", "foreach", "KernelKnn", "randomForest", "FactoMineR",'kernlab', 'data.table')
